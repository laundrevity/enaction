...
In this work, I aim to provide a rigorous mathematical framework for enactivism by employing tools from category theory and topos theory. These mathematical structures make possible the expression of \textbf{cognition} --- the co-evolution of action and perception --- as an \textbf{adjunction}. This is the sense in which the essence of enaction is embodied. Furthermore, by conceptualizing the self as the initial object in the category of contexts, we find a natural correspondence with the Buddhist concept of \emph{śūnyatā} or emptiness \cite{garfield1995}.
...
\begin{itemize}
    ...
    \item In Section 4, we develop our main framework, expressing cognition as an adjunction between action and perception.
