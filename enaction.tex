...
\vspace{5px} % Add some vertical space between quotes
...
\begin{center}
    But just as the Madhyamaka dialectic, a provisional and conventional activity of the relative world, points beyond itself, so we might hope that our concept of enaction could, at least for some cognitive scientists and perhaps even for the more general milieu of scientific thought, point beyond itself to \textbf{a truer understanding of groundlessness}.
